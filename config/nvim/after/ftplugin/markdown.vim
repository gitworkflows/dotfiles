augroup markdown
  ...
  au BufEnter <buffer> lua require("gitworkflows.markdown").markdownBlocks()
  au TextChanged <buffer> lua require("gitworkflows.markdown").markdownBlocks()
  au TextChangedI <buffer> lua require("gitworkflows.markdown").markdownBlocks()
augroup END
