...
--local window = require "gitworkflows.window"
...
local function on_attach_callback(client, bufnr)
  ...
  g.map(require("gitworkflows.mappings").lsp, { silent = false }, bufnr)

  -- Configure formatting
  -- require("gitworkflows.plugins.null-ls.formatters").setup(client, bufnr)
...
local function setup()
  ...
  -- local omnisharp_bin = "/Users/gitworkflows/repos/omnisharp-osx/run"
