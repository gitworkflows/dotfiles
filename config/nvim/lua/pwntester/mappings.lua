local mappings = {
  ["all"] = {
    ...
    -- ZK
    ["n<leader>zt"] = {
      function() require("gitworkflows.zk").dailyNote() end,
  ...
  ["markdown"] = {
    ["i<C-u>"] = {
      require("gitworkflows.markdown").pasteLink,
      desc = "Paste link"
    },
    ["i<C-b>"] = {
      require("gitworkflows.markdown").insertCheckbox,
      desc = "Insert checkbox"
    },
    ["i<CR>"] = {
      require("gitworkflows.markdown").markdownEnter,
      desc = "Markdown enter"
    },
    ["no"] = {
      require("gitworkflows.markdown").markdownO,
      desc = "Markdown o"
    },
    ["nO"] = {
      require("gitworkflows.markdown").markdownShiftO,
      desc = "Markdown O"
    },
    ["n<leader>i"] = {
      require("gitworkflows.markdown").toggleEntries,
      desc = "Toggle entries"
    },
    ["v<leader>i"] = {
      [[:'<,'>lua require("gitworkflows.markdown").toggleEntries()<CR>]],
      desc = "Toggle entries"
    },
  },
  ["zk"] = {
    ...
    ["i<C-n>"] = {
      function() require("gitworkflows.zk").templateNote() end,
